...
`ifdef CV32E40P_APU_TRACE
  cv32e40p_apu_tracer apu_tracer_i (
      ...
      .rst_n       (tb_top.wrapper_i.top_i.core_i.clk_i),
      .hart_id_i   (cv32e40p_top_i.core_i.hart_id_i),
...
`ifdef CV32E40P_TRACE_EXECUTION
  cv32e40p_tracer #(
      ...
      .clk_i(wrapper_i.top_i.core_i.clk_i),  // always-running clock for tracing
      .rst_n(wrapper_i.top_i.core_i.rst_ni),

      .hart_id_i(wrapper_i.top_i.core_i.hart_id_i),  // cv32e40p_top_i.core_i. replaced by wrapper_i.top_i.core_i.

      .pc                (wrapper_i.top_i.core_i.id_stage_i.pc_id_i),
      .instr             (wrapper_i.top_i.core_i.id_stage_i.instr_rdata_i),
      .controller_state_i(wrapper_i.top_i.core_i.id_stage_i.controller_i.ctrl_fsm_cs),
      .compressed        (wrapper_i.top_i.core_i.id_stage_i.is_compressed_i),
      .id_valid          (wrapper_i.top_i.core_i.id_stage_i.id_valid_o),
      .is_decoding       (wrapper_i.top_i.core_i.id_stage_i.is_decoding_o),
      .is_illegal        (wrapper_i.top_i.core_i.id_stage_i.illegal_insn_dec),
      .trigger_match     (wrapper_i.top_i.core_i.id_stage_i.trigger_match_i),
      .rs1_value         (wrapper_i.top_i.core_i.id_stage_i.alu_operand_a_ex_o),    // operand_a_fw_id
      .rs2_value         (wrapper_i.top_i.core_i.id_stage_i.alu_operand_b_ex_o),    // operand_b_fw_id
      .rs3_value         (wrapper_i.top_i.core_i.id_stage_i.alu_operand_c_ex_o),    // alu_operand_c 
      .rs2_value_vec     (wrapper_i.top_i.core_i.id_stage_i.alu_operand_a_ex_o),    // alu_operand_b

      .rs1_is_fp(wrapper_i.top_i.core_i.id_stage_i.decoder_i.reg_fp_a_o),
      .rs2_is_fp(wrapper_i.top_i.core_i.id_stage_i.decoder_i.reg_fp_b_o),
      .rs3_is_fp(wrapper_i.top_i.core_i.id_stage_i.decoder_i.reg_fp_c_o),
      .rd_is_fp (wrapper_i.top_i.core_i.id_stage_i.decoder_i.reg_fp_d_o),

      .ex_valid    (wrapper_i.top_i.core_i.id_stage_i.controller_i.ex_valid_i),
      .ex_reg_addr (wrapper_i.top_i.core_i.id_stage_i.regfile_alu_waddr_fw_i),
      .ex_reg_we   (wrapper_i.top_i.core_i.id_stage_i.regfile_alu_we_fw_i),
      .ex_reg_wdata(wrapper_i.top_i.core_i.id_stage_i.regfile_alu_wdata_fw_i),

      .ex_data_addr   (wrapper_i.top_i.core_i.data_addr_o),
      .ex_data_req    (wrapper_i.top_i.core_i.data_req_o),
      .ex_data_gnt    (wrapper_i.top_i.core_i.data_gnt_i),
      .ex_data_we     (wrapper_i.top_i.core_i.data_we_o),
      .ex_data_wdata  (wrapper_i.top_i.core_i.data_wdata_o),
      .data_misaligned(wrapper_i.top_i.core_i.id_stage_i.data_misaligned_i),

      .ebrk_insn(wrapper_i.top_i.core_i.id_stage_i.decoder_i.ebrk_insn_o),
      .debug_mode(wrapper_i.top_i.core_i.id_stage_i.controller_i.debug_mode_o),
      .ebrk_force_debug_mode(1'b0),  // wrapper_i.top_i.core_i.id_stage_i.controller_i.ebrk_force_debug_mode), it is now a signal, so not easy to access.
      .wb_bypass(wrapper_i.top_i.core_i.id_stage_i.branch_in_ex_o),

      .wb_valid    (wrapper_i.top_i.core_i.id_stage_i.wb_ready_i),
      .wb_reg_addr (wrapper_i.top_i.core_i.ex_stage_i.regfile_waddr_wb_o),
      .wb_reg_we   (1'b0),  // wrapper_i.top_i.core_i.id_stage_i.regfile_we_wb_i
      .wb_reg_wdata(wrapper_i.top_i.core_i.ex_stage_i.regfile_wdata_wb_o),

      .imm_u_type       (32'h00000000),  // wrapper_i.top_i.core_i.id_stage_i.imm_u_type
      .imm_uj_type     (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_uj_type),
      .imm_i_type      (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_i_type),
      .imm_iz_type     (12'h000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_iz_type[11:0]),
      .imm_z_type      (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_z_type),
      .imm_s_type      (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_s_type),
      .imm_sb_type     (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_sb_type),
      .imm_s2_type     (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_s2_type),
      .imm_s3_type     (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_s3_type),
      .imm_vs_type     (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_vs_type),
      .imm_vu_type     (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_vu_type),
      .imm_shuffle_type    (32'h00000000),  // (wrapper_i.top_i.core_i.id_stage_i.imm_shuffle_type),
      .imm_clip_type   (5'b00000),  // (wrapper_i.top_i.core_i.id_stage_i.instr_rdata_i[11:7]),
      .apu_en_i         (wrapper_i.top_i.core_i.apu_req_o),
      .apu_singlecycle_i(1'b0),   // (wrapper_i.top_i.core_i.ex_stage_i.apu_singlecycle),
      .apu_multicycle_i (wrapper_i.top_i.core_i.ex_stage_i.mult_multicycle_o),
      .apu_rvalid_i     (wrapper_i.top_i.core_i.ex_stage_i.apu_rvalid_i)
  );
`endif
